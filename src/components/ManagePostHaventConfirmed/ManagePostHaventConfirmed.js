...
import "./ManagePostHaventConfirmed.css";
...
function ManagePostHaventConfirmed(props) {
...
export default connect(mapStateToProps, mapDispatchToProps)(ManagePostHaventConfirmed);
